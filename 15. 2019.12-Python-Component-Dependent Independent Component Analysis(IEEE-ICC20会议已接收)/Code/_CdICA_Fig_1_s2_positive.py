...
if __name__ == '__main__':
    ...
    plt.annotate(s=r'$(0,a_{1, 2}{\mathbf{s}_2}^T)$' ,xy=(points_x[0],points_y[0]),xytext=(points_x[0]+0.2,points_y[0]-0.15) )
    plt.annotate(s=r'$(0,{\mathbf{s}_2}^T$)' ,xy=(points_x[1],points_y[1]),xytext=(points_x[1]-1.35,points_y[1]+0.1) )
    ...
    plt.annotate(s=r'$0$' ,xy=(0,0),xytext=(-0.4,-0.4) )
    ...
    plt.annotate(s=r'${\mathbf{s}_1}^T$' ,xy=(lim+0.1,0.1),xytext=(lim+0.1,0.2) )
