...
int g_setangle[]={0,0,75,180,180},g_movflag;
...
const int pulsesmin[]={2050,600,600,500,700};//定义最小脉宽
const int pulsesmax[]={600,2000,1300,700,900};//定义最大脉宽
int pulsesnow[]={2050,800,600,500,700};//定义当前脉宽
//int anglemin[] ={0   ,0   ,0 ,0  ,0  };
...
void stmovcontrol(int angl11,int angl12,int angl13,int angl14,int angl15)//定义一个脉冲函数
{
  int ipulse[5],iangle[]={angl11,angl12,angl13,angl14,angl15};
  float ite;
  g_movflag=1; 
  for(int i=0;i<5;i++)
  { 
