...
int g_numi[]={0,0},g_lcdi;//lcd当前取放物品的位置号显示辅助变量
...
const int pulsesmin[]={600,600,600,500,700};//定义各个舵机实际最小脉宽
const int pulsesmax[]={2050,2000,1500,1600,2000};//定义各个舵机实际最大脉宽
...
void setup()
{
  ...
  MsTimer2::set(18, flash); // 20ms period
