...
public:
	...
	//PARAMETERS//////////////////////////////////////////////////////////////
	const int stimulus_frequecy = 400;
	...
	//INITIALIZATION//////////////////////////////////////////////////////////////
	XAL2(const int input_sample_rate, const double input_buffersize_sec)
	{
	...
	void calculateAngle(SampleBufferFormat* SampleBuffer, double* deltaAngle)
	{
		...
		SAMPLE* cross_correlations_left = new SAMPLE[max_propagation_delay]();
		SAMPLE* cross_correlations_right = new SAMPLE[max_propagation_delay]();
		for (int k = 0; k < max_propagation_delay; k++)
		{
